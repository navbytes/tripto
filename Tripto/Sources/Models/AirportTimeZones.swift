...
enum AirportTimeZones {
    private static let map: [String: String] = [
        ...
        "PAT": "Asia/Kolkata", "CCU": "Asia/Kolkata",
        "SIN": "Asia/Singapore", "HKG": "Asia/Hong_Kong", "BKK": "Asia/Bangkok", "HKT": "Asia/Bangkok",
        "NRT": "Asia/Tokyo", "HND": "Asia/Tokyo", "KIX": "Asia/Tokyo", "OKA": "Asia/Tokyo",
        "ICN": "Asia/Seoul", "PEK": "Asia/Shanghai", "PVG": "Asia/Shanghai",
        "NKG": "Asia/Shanghai", "LJG": "Asia/Shanghai", "SZX": "Asia/Shanghai", "CTU": "Asia/Shanghai",
        "SYD": "Australia/Sydney", "MEL": "Australia/Melbourne", "AKL": "Pacific/Auckland", "ZQN": "Pacific/Auckland",
    ...
    private static let cityNames: [String: String] = [
        ...
        "PAT": "Patna", "CCU": "Kolkata",
        "SIN": "Singapore", "HKG": "Hong Kong", "BKK": "Bangkok", "HKT": "Phuket",
        "NRT": "Tokyo", "HND": "Tokyo", "KIX": "Osaka", "OKA": "Okinawa",
        "ICN": "Seoul", "PEK": "Beijing", "PVG": "Shanghai",
        "NKG": "Nanjing", "LJG": "Lijiang", "SZX": "Shenzhen", "CTU": "Chengdu",
        "SYD": "Sydney", "MEL": "Melbourne", "AKL": "Auckland", "ZQN": "Queenstown",
